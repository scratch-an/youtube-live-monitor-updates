...
def transcribe_chunks(
    ...
    with txt_path.open("a", encoding="utf-8") as f:
        ...
        f.write(f"チャンク: {CONFIG['chunk_seconds']}秒 / 認識単位: {2 if source_language == 'en' else 1}チャンク\n")
